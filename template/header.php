        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    <li class="nav-item">
                        <a class="nav-link <?php echo !isset($_GET['page']) && empty($_GET['page']) ? 'active' : '' ?>" href="index.php">
                            <span class="nav-icon">
                    ...
                    <li class="nav-item has-submenu">
                        <a class="nav-link submenu-toggle <?php echo isset($_GET['page']) && $_GET['page'] == 'rabbit_data' || isset($_GET['page']) && $_GET['page'] == 'rabbit_hb' || isset($_GET['page']) && $_GET['page'] == 'rabbit_heal' ? 'active' : '' ?>" data-bs-toggle="collapse" data-bs-target="#submenu-1" aria-expanded="false" aria-controls="submenu-1">
                            ...
                            <span class="nav-link-text">เกี่ยวกับกระต่าย</span>
                    ...
                    <!-- <li class="nav-item has-submenu">
                        ...
                        <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-3" aria-expanded="false" aria-controls="submenu-3">
                            ...
                            <span class="nav-link-text">เกี่ยวกับกระต่าย3</span>
                            <span class="submenu-arrow">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                                </svg>
                        ...
                        <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link" href="#">ข้อมูลกระต่าย</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="#">ข้อมูลการผสมพันธ์ุ</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="#">ข้อมูลการรับการักษา</a></li>
                            </ul>
                        </div>
                    </li> -->
                    <li class="nav-item has-submenu">
                        <a class="nav-link submenu-toggle <?php echo isset($_GET['page']) && $_GET['page'] == 'admin' || isset($_GET['page']) && $_GET['page'] == 'emp' ? 'active' : '' ?>" data-bs-toggle="collapse" data-bs-target="#submenu-2" aria-expanded="false" aria-controls="submenu-2">
                            <span class="nav-icon">
                        ...
                        <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link <?php echo isset($_GET['page']) && $_GET['page'] == 'admin' ? 'active' : '' ?>" href="?page=admin">ข้อมูลแอดมิน</a></li>
